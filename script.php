		...
		$container->set(
			...
			new class ($container->get(AdministratorApplication::class)) implements InstallerScriptInterface
			{
				...
				protected function checkCompatible(): bool
				{
					...
					{
						$app->enqueueMessage(
							Text::sprintf('PLG_RADICALMART_WISHBOXCDEK_ERROR_COMPATIBLE_JOOMLA', $this->minimumJoomla),
							'error'
						);
					...
					{
						$app->enqueueMessage(
							Text::sprintf('PKG_RADICALMART_WISHBOXCDEK_ERROR_COMPATIBLE_PHP', $this->minimumPhp),
							'error'
						);
